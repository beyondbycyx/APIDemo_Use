...
/**
 *
 * 输入关键字，使用系统contentprovider查找出相关联系人的名字
 * */
public class AutoComplete4 extends Activity {
    ...
    //为CursorAdapter添加过滤功能
    public static class ContactListAdapter extends CursorAdapter implements Filterable {
        public ContactListAdapter(Context context, Cursor c) {
            super(context, c);
            //取得activity中的resolver
        ...
        //将cursor的内容转变成字符串，用来当用户选择某个item时，将字符串返回给用户
        @Override
        public String convertToString(Cursor cursor) {
            return cursor.getString(COLUMN_DISPLAY_NAME);
        }
        //在后台线程更新查询的数据，通过给出的约束字眼
        @Override
